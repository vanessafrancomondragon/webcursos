...
class RegistroController
{
    ...
    public static function crear(Router $router)
    {
        ...
        // Verificiar si el usuario ya esta registrado
    ...
    public static function conferencias(Router $router)
    {
        ...
        // Redireccionar a boleto virtual en caso de haber finalizado su registro o elegir los eventos para finalizar el registro
